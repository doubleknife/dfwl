package com.dfwl.fleet.tire.controller;
...
public class TireController {
    ...
    private final TireAccessPolicy tireAccessPolicy;

    public TireController(TireService tireService, TireAccessPolicy tireAccessPolicy) {
        this.tireService = tireService;
        this.tireAccessPolicy = tireAccessPolicy;
    }
    ...
    public ApiResponse<TireRequestResponse> createRequest(
        ...
        tireAccessPolicy.ensureDriverCanUseTireRequest(user, request.driverId(), request.vehicleId());
    ...
    public ApiResponse<OcrRecordResponse> recognize(
        ...
        tireAccessPolicy.ensureDriverCanUseTireOcr(user);
