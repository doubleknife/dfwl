package com.dfwl.fleet.approval.controller;
...
import com.dfwl.fleet.approval.policy.ApprovalAccessPolicy;
...
public class ApprovalController {
    ...
    private final ApprovalAccessPolicy approvalAccessPolicy;

    public ApprovalController(ApprovalService approvalService, ApprovalAccessPolicy approvalAccessPolicy) {
        this.approvalService = approvalService;
        this.approvalAccessPolicy = approvalAccessPolicy;
    }
    ...
    public ApiResponse<PageResponse<ApprovalFlowResponse>> listFlows(
            ...
            @RequestParam(defaultValue = "1") int pageNo,
            @RequestParam(defaultValue = "20") int pageSize) {
        approvalAccessPolicy.ensureCanManageFlows(user);
    ...
    public ApiResponse<ApprovalResponse> create(
        ...
        approvalAccessPolicy.ensureCanSubmit(user, request.approvalType(), request.businessType());
    ...
    public ApiResponse<ApprovalResponse> approve(
        ...
        approvalAccessPolicy.ensureCanProcess(user);
